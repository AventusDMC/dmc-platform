...
// Memoized row — re-renders only when its own props change, not when
// an unrelated row's expandedId/editingId/deletingId flips. With 57
// rows this cuts re-render fan-out from 57 to ~2 per click and stops
// the 'Page Unresponsive' dialog firing during the initial mount.
