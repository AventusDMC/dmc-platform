...
// Hotels Engine v2 — rate cell edit / delete Server Actions (PR-A4).
//
...
function revalidateRateScope(hotelId: string, contractId: string, rateId?: string) {
  ...
  if (rateId) {
    revalidatePath(`/hotels-v2/${hotelId}/contracts/${contractId}/rates/${rateId}/edit`);
  }
}
...
export async function updateRate(
  ...
  redirect(`/hotels-v2/${hotelId}/contracts/${contractId}/rates`);
}
