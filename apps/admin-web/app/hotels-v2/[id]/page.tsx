...
// Hotels Engine v2 — Phase 1 PR #145.
//
...
//
//   /hotels-v2/[id]/edit               — edit master data (PR #146)
//   /hotels-v2/[id]/rooms              — manage room types (PR #146/#147)
//   /hotels-v2/[id]/contracts/new      — contract wizard (PR #148-#150)
//   /hotels-v2/[id]/allotments         — inventory calendar (PR #151)
...
async function getHotel(id: string): Promise<HotelDetail | null> {
  try {
    ...
    console.error('[hotels-v2/[id]] hotel detail unavailable', error);
    return null;
  }
}
    ...
    <main className="page">
      <section className="panel workspace-panel workspace-panel-wide">
        <header style={{ marginBottom: '1.5rem' }}>
          <p className="eyebrow">Hotels Engine v2 — Hotel detail</p>
        ...
        {/* Master data card */}
        <section
          data-testid="hotel-v2-master-data"
        ...
        {/* Room types */}
        <section data-testid="hotel-v2-room-types" style={{ marginBottom: '1.5rem' }}>
          <h2 className="section-title" style={{ fontSize: '1.05rem', marginBottom: '0.6rem' }}>
        ...
        {/* Contracts summary */}
        <section data-testid="hotel-v2-contracts">
          <h2 className="section-title" style={{ fontSize: '1.05rem', marginBottom: '0.6rem' }}>
        ...
        >
          /hotels-v2/{hotel.id} — pure server component, no client JS. Action buttons are
