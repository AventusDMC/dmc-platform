...
// Hotels Engine — Phase 1, foundation list view.
//
...
//
// /hotels is the clean rebuild: this list page is a PURE server
...
//   /hotels/[id]/rooms     — room types CRUD
//   /hotels/[id]/contracts/new — contract wizard
//   /hotels/[id]/allotments — inventory calendar
//   /hotels/quote-simulator — pricing simulator
    ...
    <main className="page">
      <section className="panel workspace-panel workspace-panel-wide">
        <header style={{ marginBottom: '1.5rem' }}>
          <p className="eyebrow">Hotels Engine — Phase 1</p>
          ...
          <p className="table-subcopy" style={{ marginTop: '0.5rem' }}>
            <Link href="/hotels/import" prefetch={false}>
        ...
        {hotels.length === 0 ? (
          ...
          <div className="table-wrap">
            <table className="data-table" data-testid="hotels-table">
              <thead>
                <tr>
                  <th>Hotel</th>
                  <th>City</th>
        ...
        <p className="table-subcopy" style={{ marginTop: '1.5rem', color: 'var(--ds-color-text-faint, #94A3B8)', fontSize: '0.75rem' }}>
          /hotels — pure server component, no client JS beyond the global admin shell.
